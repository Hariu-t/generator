...
          {/* 放送情報バッジ */}
          <div style={itemFieldStyle}>
              <label style={labelStyle}>配信バッジ種別</label>
              <select
...
          </div>
          ...
          <div style={itemFieldStyle}>
            <label style={labelStyle}>チャンネル番号</label>
            <input
              type="text"
          ...
          <div style={itemFieldStyle}>
            <label style={labelStyle}>チャンネル名</label>
            <input
              type="text"
...
      <div style={sectionStyle}>
        <div style={itemHeaderStyle}>
          <h3 style={sectionTitleStyle}>カルーセルアイテム（画像・動画）</h3>
        </div>
